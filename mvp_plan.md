...
### Week 2: 백엔드 인프라 & 데이터 (5일)
**목표**: 안정적인 데이터 저장 및 인증 시스템

#### Day 1-3: 데이터베이스 & 마이그레이션
- [ ] PostgreSQL 스키마 구현 (Supabase 또는 Railway)
- [ ] 기존 인메모리 데이터를 DB로 마이그레이션
- [ ] 데이터 백업/복구 시스템

#### Day 4-5: 인증 & 세션 관리
- [ ] JWT 기반 인증 시스템
- [ ] 플레이어 세션 관리
- [ ] 기본적인 RBAC (역할 기반 접근 제어)

### Week 3: API 완성 & 테스트 (5일)
**목표**: 안정적인 RESTful API 및 테스트 자동화

#### Day 1-3: FastAPI 엔드포인트 완성
- [ ] CRUD 엔드포인트: 플레이어, 퍼즐, 진행도
- [ ] 실시간 데이터 연동 (Yahoo Finance API)
- [ ] API 속도 제한 및 에러 처리
...
### Week 4: 웹 클라이언트 MVP (5일)
**목표**: 반응형 웹 앱으로 핵심 기능 구현

#### Day 1-2: 프론트엔드 프레임워크 선택 & 설정
- [ ] Next.js 또는 Streamlit (빠른 프로토타이핑)
- [ ] 기본 UI 컴포넌트 라이브러리
- [ ] API 연동 클라이언트
